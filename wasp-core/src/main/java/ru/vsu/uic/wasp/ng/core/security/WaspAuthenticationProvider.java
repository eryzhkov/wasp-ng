...
public class WaspAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (user != null) {
            ...
            if (user.isAccountLocked()) {
                ...
                OffsetDateTime expirationDateTime = user.getLockedAt().plus(lockExpirationMinutes, ChronoUnit.MINUTES);
    ...
    protected boolean lockAccountIfNeeded(User user) {
        ...
        OffsetDateTime lastFailedLoginAt = user.getLastFailedLoginAt();
